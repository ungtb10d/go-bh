...
func TestConfigDir(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			output: filepath.Join(tempDir, ".config", "bh"),
		},
		{
		...
		},
		{
			...
			output: filepath.Join(tempDir, "bh"),
		},
		{
...
func TestStateDir(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			output: filepath.Join(tempDir, ".local", "state", "bh"),
		},
		{
...
func TestDataDir(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			output: filepath.Join(tempDir, ".local", "share", "bh"),
		},
		{
